...
const fiche: Projet = {
  ...
  puce: "STM32F1 · CAN",
  film: {
    src: "/videos/reseau-capteurs.mp4",
    affiche: "/videos/reseau-capteurs.webp",
    duree: "3 min 25, commentée",
    legende:
      "La démonstration, sans une seule carte branchée. On attrape le solide de la centrale et on le tourne, on éloigne une cible du capteur de temps de vol, on masque sa lampe avec une main, on agite un soufflet devant l'hélice de l'anémomètre. À chaque geste, le capteur lit la scène, compose sa trame, l'envoie sur le bus, et l'interface affiche ce qu'elle reçoit.",
    chapitres: [
      { instant: 0, titre: "Le réseau de capteurs sur bus CAN" },
      { instant: 9, titre: "Plus de cartes, donc plus rien à montrer" },
      { instant: 18, titre: "La barre d'état dit toujours d'où viennent les chiffres" },
      { instant: 27, titre: "Le geste passe par le bus, il ne court-circuite rien" },
      { instant: 35, titre: "La centrale inertielle : on attrape le solide" },
      { instant: 43, titre: "Les angles suivent, et la cadence le prouve" },
      { instant: 51, titre: "Les trames brutes portent les mêmes angles" },
      { instant: 63, titre: "Le temps de vol : on éloigne la cible" },
      { instant: 73, titre: "La courbe est sous la scène, pas dans un onglet" },
      { instant: 82, titre: "Le même composant, en mesure d'éclairement" },
      { instant: 91, titre: "La main masque la lampe, l'éclairement tombe" },
      { instant: 101, titre: "Sélectionner un objet fait apparaître ses réglages" },
      { instant: 110, titre: "L'anémomètre : le vent se produit" },
      { instant: 120, titre: "L'énergie récoltée s'accumule" },
      { instant: 128, titre: "La jauge décide si le moteur peut démarrer" },
      { instant: 141, titre: "Le moteur tourne sur la réserve, et la vide" },
      { instant: 149, titre: "Chaque panneau se déplace et se détache" },
      { instant: 158, titre: "L'ancrage vient de Qt, rien n'est réécrit" },
      { instant: 170, titre: "Chercher ce qui existe avant d'écrire" },
      { instant: 183, titre: "Ces trames s'enregistrent, et se rejouent" },
      { instant: 193, titre: "git-portfolio-rivaldo.vercel.app" },
    ],
  },
  couverture: {
    src: centrale,
