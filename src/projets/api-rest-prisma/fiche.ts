...
assert.equal(modification.status, 200);`,
  ...
  film: {
    ...
    duree: "3 min 18, commenté par une voix de synthèse",
    legende:
    ...
    chapitres: [
      ...
      { instant: 7, titre: "Le sujet est modeste, la garde ne l'est pas" },
      ...
      { instant: 38, titre: "Comment la page affiche-t-elle les plats ?" },
      { instant: 44, titre: "Le serveur lit, le navigateur reçoit" },
      { instant: 56, titre: "Catégorie, calories, étiquettes, date" },
      ...
      { instant: 104, titre: "Le plus petit modèle qui suffit" },
      { instant: 114, titre: "La saisie à la main" },
      { instant: 121, titre: "Le serveur revérifie ce que l'écran a laissé passer" },
      { instant: 129, titre: "Description, calories, étiquettes" },
      { instant: 137, titre: "Une seule porte, pour l'humain comme pour la machine" },
      { instant: 145, titre: "La même garde au début de chaque verbe" },
      { instant: 154, titre: "Le schéma décrit une fois, les types suivent" },
      { instant: 167, titre: "Vérifiée à chaque modification" },
      { instant: 175, titre: "La sonde interrogée après le déploiement" },
