...
const fiche: Projet = {
  ...
  film: {
    ...
    duree: "3 min 40, commenté à la voix",
    legende:
      "Le parcours complet de l'application, filmé sur l'adresse publique : la carte des collectes de l'EFS, la recherche d'une ville, les filtres, le détail d'un lieu avec son temps de trajet, le compte de découverte, le calcul du prochain don, les alertes, les rendez-vous, le parrainage, l'assistant, puis la réponse brute de l'API et la chaîne qui la vérifie.",
    chapitres: [
      { instant: 0, titre: "DonVie, une application du don du sang" },
      { instant: 5, titre: "Où aller, et en ai-je le droit" },
      { instant: 13, titre: "De vraies collectes, pas des exemples" },
      { instant: 23, titre: "Distance, date, places restantes" },
      { instant: 30, titre: "Chercher une ville ou une rue" },
      { instant: 36, titre: "La carte suit l'adresse choisie" },
      { instant: 43, titre: "Trois réglages pour affiner" },
      { instant: 51, titre: "Jusqu'à soixante kilomètres" },
      { instant: 59, titre: "Le détail d'un lieu de collecte" },
      { instant: 67, titre: "Le trajet, à pied ou en voiture" },
      { instant: 74, titre: "La réservation reste chez l'EFS" },
      { instant: 84, titre: "Visitable sans compte" },
      { instant: 91, titre: "Un compte de découverte, déjà rempli" },
      { instant: 97, titre: "La date du prochain don possible" },
      { instant: 104, titre: "Les délais de l'EFS, appliqués" },
      { instant: 113, titre: "Les collectes qui manquent de monde" },
      { instant: 121, titre: "Agenda, rappel, itinéraire" },
      { instant: 130, titre: "Groupe sanguin et historique" },
      { instant: 137, titre: "Tout se supprime d'un geste" },
      { instant: 144, titre: "Parrainer avec un QR code" },
      { instant: 151, titre: "HemoBot répond aux questions" },
      { instant: 158, titre: "Il ne remplace pas le médecin, et il le dit" },
      { instant: 166, titre: "L'API, sa réponse brute" },
      { instant: 174, titre: "Ce qui tourne derrière" },
      { instant: 184, titre: "Ce qu'on ne voit pas à l'écran" },
      { instant: 193, titre: "Vérifiée à chaque modification" },
      { instant: 200, titre: "Trois défauts attrapés avant les visiteurs" },
      { instant: 211, titre: "donvie-rivaldo.vercel.app" },
    ],
  },
  demos: [
    {
